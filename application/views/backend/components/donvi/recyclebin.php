<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="glyphicon glyphicon-cd"></i> Thùng rác danh mục đơn vị</h1>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo base_url() ?>admin/donvi/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>
                                            </td>
                                            <td><?php echo $val['link'] ?></td>
                                            <td><?php echo $val['created_at'] ?></td>
                                            <td><?php $name=$this->Muser->user_name($val['created_by']); echo $name; ?>
                                            </td>
                                            <td class="text-center">
                                                <a class="btn btn-success btn-xs"
                                                    href="admin/donvi/restore/<?php echo $val['id'] ?>" role="button">
                                            ...
                                            <?php  
												...
												if($user['role']==1){
													$ktRole.='
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/donvi/delete/'.$val['id'].'" role = "button">
