								...
								<table class="table table-hover table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url() ?>admin/monhoc/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>
											</td>

											<td class="text-center">
												<a class="btn btn-success btn-xs" href="admin/monhoc/restore/<?php echo $val['id'] ?>" role = "button">
											...
											<?php
												...
												if($user['role']==1){
													$ktRole.='
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/monhoc/delete/'.$val['id'].'" role = "button">
