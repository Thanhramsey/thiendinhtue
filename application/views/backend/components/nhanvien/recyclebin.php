<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="glyphicon glyphicon-cd"></i> Thùng rác danh mục nhân viên</h1>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo base_url() ?>admin/nhanvien/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>
                                            </td>

                                            <td class="text-center">
                                                <a class="btn btn-success btn-xs"
                                                    href="admin/nhanvien/restore/<?php echo $val['id'] ?>"
                                                    role="button">
                                            ...
                                            <?php
												...
												if($user['role']==1){
													$ktRole.='
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/nhanvien/delete/'.$val['id'].'" role = "button">
