                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        <option value="1" <?php if($row['type'] == 1) {echo 'selected';}?>>Slider
                                        </option>
                                        <option value="2" <?php if($row['type'] == 2) {echo 'selected';}?>>Hình ảnh
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" <?php if($row['status'] == 1) {echo 'selected';}?>>Hoạt động
                                        </option>
