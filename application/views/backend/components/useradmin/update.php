...
<div class="content-wrapper">
    <form action="<?php echo base_url() ?>admin/useradmin/update.html" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="box" id="view">
                        <div class="box-body">
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label>Đơn vị</label>
                                    <select class="select2" name="donviid" id="donviid" class="form-control"
                                        style="width:100%">
                                        <?php foreach ($listDonvi as $ca): ?>
                                        <option value="<?php echo $ca['id'];?>"
                                            <?php if($ca['id'] == $row['donviid']) {echo 'selected';}?>>
                                            <?php echo $ca['name']; ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="gender" class="form-control">
                                        <option value="1" <?php if($row['gender'] == 1) {echo 'selected';}?>>Nam
                                        </option>
                                ...
                                <div class="form-group">
                                    <div class="anh">
                                        ...
                                        <img src="public/images/admin/<?php echo $row['img'] ?>"
                                            style="width:100%; height:100%" id="output" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" <?php if($row['status'] == 1) {echo 'selected';}?>>Kích hoạt
                                        </option>
                                        <option value="0" <?php if($row['status'] == 0) {echo 'selected';}?>>Chưa kích
                                            hoạt</option>
                                    </select>
                                </div>
                                <div class="form-group">
