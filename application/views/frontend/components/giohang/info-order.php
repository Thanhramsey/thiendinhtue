        ...
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" name='info-order'
                    ...
                    <div class="checkout-content" style="margin-top:20px">
                        <div class="col-xs-12 col-sm-12 col-md-8 col-login-checkout" style="margin-bottom: 20px">

                            <h1 class="text-left" style="color:#d91d34">Địa chỉ giao hàng của quý khách</h1>
                            <div class="wrap-info"
                                ...
                                <table class="table tinfo" style="width: 80%;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên"
                                                    name="name" value="<?php if (empty($user['fullname'])) {
																																			echo "";
																																		} else {
																																			echo $user['fullname'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Số điện thoại"
                                                    name="phone" value="<?php if (empty($user['phone'])) {
																																				echo "";
																																			} else {
																																				echo $user['phone'];
																																			} ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="address" placeholder="Địa chỉ giao hàng:"
                                                    class="form-control" rows="4"="" style="height: auto !important;"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="coupon" style="border-radius: 5px; border-color: #262144;"
                                            ...
                                            <td style="border: none;">
                                                <div class="btn-checkout frame-100-1 overflow-hidden border-pri"
                                                    ...
                                                    <button type="submit" style="width: 300px"
                                                        class="bg-pri border-pri col-fff" name="dathang">Đặt
                                                        hàng</button>
                                            </td>
                                        </tr>
                                    </tbody>
