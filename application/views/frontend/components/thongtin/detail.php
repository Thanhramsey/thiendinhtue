<section>
    <div class="container order-page product-wrap">
        ...
        <div class="or-detail-c">
            <div class="col-sm-8">
                ...
                <div class="content-order">
                    ...
                    <p> Địa chỉ giao hàng: <?php echo $info['address'] ?>,
                        <?php echo $this->Mdistrict->district_name($info['district']); ?>,
                        <?php echo $this->Mprovince->province_name($info['province']);?></p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="general__title">
						...
						?>
                            <tr>
                                ...
                                <td class="text-right"><span
                                        style="color: red; font-size: 23px;"><?php echo number_format($info['money']) ?>
                                        VNĐ</span></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-xs-12">
                <button class="btn"><a href="javascript:;" onclick="window.history.go(-1);" class="viewMore pull-left"
